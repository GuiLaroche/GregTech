...
recipes.remove(<item:laendli_transport:parachute_backpack_chestplate>);
...
craftingTable.remove(<item:brewery:pretzel>);
craftingTable.remove(<item:brewery:gingerbread>);
craftingTable.removeByName("minecraft:cake");
craftingTable.removeByName("naturalist:cake");
...
craftingTable.remove(<item:brewery:wooden_brewingstation>);
...
craftingTable.remove(<item:supplementaries:bellows>);
...
craftingTable.remove(<item:supplementaries:hourglass>);
craftingTable.remove(<item:supplementaries:wind_vane>);
craftingTable.remove(<item:supplementaries:faucet>);
craftingTable.remove(<item:alexsmobs:flying_fish_boots>);
craftingTable.remove(<item:alexsmobs:moose_headgear>);
craftingTable.remove(<item:dungeonnowloading:soul_silk>);
craftingTable.remove(<item:smallships:cannon>);
//craftingTable.removeByName("minecraft:minecart");
//craftingTable.remove(<item:minecraft:bow>);
//craftingTable.remove(<item:minecraft:crossbow>);
craftingTable.remove(<item:supplementaries:rope>);
craftingTable.remove(<item:supplementaries:cage>);
craftingTable.remove(<item:alexsmobs:hummingbird_feeder>);
...
craftingTable.remove(<item:gtceu:flint_axe>);
craftingTable.remove(<item:gtceu:flint_sword>);
craftingTable.remove(<item:gtceu:flint_knife>);
...
craftingTable.addShaped("n_recipe_parachute", <item:laendli_transport:parachute_backpack_chestplate>, [[<item:minecraft:air>, <item:laendli_transport:vehicle_part_airsac>, <item:minecraft:air>], [<item:supplementaries:rope>, <item:minecraft:air>, <item:supplementaries:rope>], [<item:supplementaries:rope>, <item:minecraft:leather_chestplate>, <item:supplementaries:rope>]]);
...
craftingTable.addShaped("n_pretzel", <item:brewery:pretzel> * 6, [[<tag:items:forge:dough>, <tag:items:forge:dough>, <item:minecraft:air>], [<tag:items:forge:dough>, <tag:items:forge:dough>, <tag:items:forge:dough>], [<item:minecraft:air>, <tag:items:forge:dough>, <tag:items:forge:dough>]]);
craftingTable.addShaped("n_gingerbread", <item:brewery:gingerbread> * 2, [[<tag:items:forge:dough>, <item:minecraft:air>, <tag:items:forge:dough>], [<tag:items:forge:dough>, <tag:items:forge:dough>, <tag:items:forge:dough>], [<item:minecraft:air>, <tag:items:forge:dough>, <item:minecraft:air>]]);
craftingTable.addShaped("n_cake", <item:minecraft:cake>, [[<tag:items:forge:buckets/milk>, <tag:items:forge:buckets/milk>, <tag:items:forge:buckets/milk>], [<item:minecraft:sugar>, <tag:items:forge:eggs>, <item:minecraft:sugar>], [<tag:items:forge:dough>, <tag:items:forge:dough>, <tag:items:forge:dough>]]);
craftingTable.addShaped("n_wooden_brewingstation", <item:brewery:wooden_brewingstation>, [[<item:minecraft:air>, <item:minecraft:air>, <tag:items:forge:double_plates/steel>], [<item:minecraft:furnace>, <item:minecraft:cauldron>, <item:minecraft:cauldron>], [<item:gtceu:treated_wood_planks>, <item:gtceu:treated_wood_planks>, <item:gtceu:treated_wood_planks>]]);

#. New Early game/vanilla stuff

craftingTable.addShaped("n_altimeter", <item:supplementaries:altimeter>, [[<item:minecraft:air>, <tag:items:forge:plates/copper>, <item:minecraft:air>], [<tag:items:forge:plates/copper>, <tag:items:forge:bolts/red_alloy>, <tag:items:forge:plates/copper>], [<item:minecraft:air>, <tag:items:forge:plates/copper>, <item:minecraft:air>]]);
craftingTable.addShaped("n_shield", <item:minecraft:shield>, [[<tag:items:forge:plates/iron>, <tag:items:forge:plates/iron>, <tag:items:forge:plates/iron>], [<tag:items:forge:plates/iron>, <tag:items:minecraft:logs>, <tag:items:forge:plates/iron>], [<tag:items:forge:screws/iron>, <tag:items:forge:plates/iron>, <tag:items:forge:screws/iron>]]);
...
craftingTable.addShaped("n_sack", <item:supplementaries:sack>, [[<tag:items:forge:crops/flax>, <tag:items:forge:ropes>, <tag:items:forge:crops/flax>], [<tag:items:forge:crops/flax>, <item:minecraft:air>, <tag:items:forge:crops/flax>], [<tag:items:forge:crops/flax>, <tag:items:forge:crops/flax>, <tag:items:forge:crops/flax>]]);
craftingTable.addShaped("n_lead", <item:minecraft:lead>, [[<tag:items:forge:ropes>, <tag:items:forge:ropes>, <item:minecraft:air>], [<tag:items:forge:ropes>, <item:minecraft:slime_ball>, <item:minecraft:air>], [<item:minecraft:air>, <item:minecraft:air>, <tag:items:forge:ropes>]]);
craftingTable.addShaped("n_fishing_rod", <item:minecraft:fishing_rod>, [[<item:minecraft:air>, <item:minecraft:air>, <tag:items:forge:rods/long/wood>], [<item:minecraft:air>, <tag:items:forge:rods/long/wood>, <tag:items:forge:string>], [<tag:items:forge:rods/long/wood>, <item:minecraft:air>, <tag:items:forge:string>]]);
craftingTable.addShaped("n_straddle_helmet", <item:alexsmobs:straddle_helmet>, [[<item:minecraft:air>, <item:alexsmobs:straddlite>, <item:minecraft:air>], [<item:alexsmobs:straddlite>, <item:minecraft:air>, <item:alexsmobs:straddlite>], [<tag:items:forge:ropes>, <item:minecraft:air>, <tag:items:forge:ropes>]]);
craftingTable.addShaped("n_bellows", <item:supplementaries:bellows>, [[<item:gtceu:treated_wood_slab>, <item:gtceu:treated_wood_slab>, <item:gtceu:treated_wood_slab>], [<item:minecraft:leather>, <tag:items:forge:rings/steel>, <item:minecraft:leather>], [<item:gtceu:treated_wood_slab>, <item:gtceu:treated_wood_slab>, <item:gtceu:treated_wood_slab>]]);
//craftingTable.addShaped("n_observer", <item:minecraft:observer>, [[<tag:items:forge:stone>, <tag:items:forge:small_gears>, <tag:items:forge:stone>], [<tag:items:forge:ingots/red_alloy>, <tag:items:forge:ingots/red_alloy>, <tag:items:forge:gems/certus_quartz>], [<tag:items:forge:stone>, <tag:items:forge:gears>, <tag:items:forge:stone>]]);
//craftingTable.addShaped("n_dropper", <item:minecraft:dropper>, [[<tag:items:forge:gears>, <tag:items:forge:stone>, <tag:items:forge:gears>], [<tag:items:forge:small_gears>, <item:thermal:rf_coil>, <tag:items:forge:small_gears>], [<tag:items:forge:stone>, <tag:items:forge:ingots/red_alloy>, <tag:items:forge:stone>]]);
//craftingTable.addShaped("n_dispenser", <item:minecraft:dispenser>, [[<tag:items:forge:stone>, <item:create:precision_mechanism>, <tag:items:forge:stone>], [<tag:items:forge:gears>, <item:minecraft:bow>, <tag:items:forge:gears>], [<tag:items:forge:stone>, <tag:items:forge:ingots/red_alloy>, <tag:items:forge:stone>]]);
craftingTable.addShaped("n_relayer", <item:supplementaries:relayer>, [[<tag:items:forge:stone>, <tag:items:forge:stone>, <tag:items:forge:stone>], [<tag:items:forge:ingots/red_alloy>, <tag:items:forge:ingots/red_alloy>, <item:minecraft:iron_ingot>], [<tag:items:forge:small_gears>, <item:create:precision_mechanism>, <tag:items:forge:small_gears>]]);
craftingTable.addShaped("n_note_block", <item:minecraft:note_block>, [[<tag:items:minecraft:planks>, <tag:items:minecraft:planks>, <tag:items:minecraft:planks>], [<tag:items:minecraft:planks>, <tag:items:forge:ingots/red_alloy>, <tag:items:minecraft:planks>], [<tag:items:minecraft:planks>, <tag:items:minecraft:planks>, <tag:items:minecraft:planks>]]);
craftingTable.addShaped("n_cog_block", <item:supplementaries:cog_block> * 6, [[<tag:items:forge:double_plates/copper>, <tag:items:forge:double_plates/copper>, <tag:items:forge:double_plates/copper>], [<tag:items:forge:double_plates/copper>, <item:minecraft:redstone_block>, <tag:items:forge:double_plates/copper>], [<tag:items:forge:double_plates/copper>, <tag:items:forge:double_plates/copper>, <tag:items:forge:double_plates/copper>]]);
craftingTable.addShaped("n_clock_block", <item:supplementaries:clock_block>, [[<tag:items:forge:treated_wood>, <tag:items:forge:treated_wood>, <tag:items:forge:treated_wood>], [<tag:items:forge:treated_wood>, <item:minecraft:clock>, <tag:items:forge:treated_wood>], [<tag:items:forge:treated_wood>, <tag:items:forge:treated_wood>, <tag:items:forge:treated_wood>]]);
craftingTable.addShaped("n_speaker_block", <item:supplementaries:speaker_block>, [[<tag:items:minecraft:planks>, <tag:items:minecraft:planks>, <tag:items:minecraft:planks>], [<tag:items:minecraft:planks>, <tag:items:forge:plates/rubber>, <tag:items:minecraft:planks>], [<tag:items:minecraft:planks>, <tag:items:minecraft:planks>, <tag:items:minecraft:planks>]]);
craftingTable.addShaped("n_hourglass", <item:supplementaries:hourglass>, [[<item:minecraft:glass>, <tag:items:forge:plates/gold>, <item:minecraft:glass>], [<item:minecraft:air>, <item:minecraft:glass>, <item:minecraft:air>], [<item:minecraft:glass>, <tag:items:forge:plates/gold>, <item:minecraft:glass>]]);
craftingTable.addShaped("n_wind_vane", <item:supplementaries:wind_vane>, [[<item:minecraft:air>, <tag:items:forge:rods/iron>, <item:minecraft:air>], [<tag:items:forge:rods/iron>, <item:minecraft:iron_bars>, <tag:items:forge:rods/iron>], [<item:minecraft:air>, <item:minecraft:redstone>, <item:minecraft:air>]]);
craftingTable.addShaped("n_faucet", <item:supplementaries:faucet>, [[<item:minecraft:air>, <tag:items:forge:gears/wood>, <item:minecraft:air>], [<item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>], [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:iron_ingot>]]);
craftingTable.addShaped("n_flying_fish_boots", <item:alexsmobs:flying_fish_boots>, [[<tag:items:forge:ropes>, <item:minecraft:air>, <tag:items:forge:ropes>], [<item:alexsmobs:flying_fish>, <item:minecraft:air>, <item:alexsmobs:flying_fish>]]);
craftingTable.addShaped("n_moose_headgear", <item:alexsmobs:moose_headgear>, [[<item:alexsmobs:moose_antler>, <tag:items:forge:ingots/iron>, <item:alexsmobs:moose_antler>], [<tag:items:forge:ropes>, <item:minecraft:air>, <tag:items:forge:ropes>]]);
...
craftingTable.addShaped("n_hummingbird_feeder", <item:alexsmobs:hummingbird_feeder>, [[<item:minecraft:air>, <tag:items:forge:plates/copper>, <item:minecraft:air>], [<tag:items:forge:plates/copper>, <item:minecraft:glass_bottle>, <tag:items:forge:plates/copper>], [<item:minecraft:sunflower>, <tag:items:forge:plates/copper>, <item:minecraft:sunflower>]]);
...
craftingTable.addShaped("n_smithing_table", <item:minecraft:smithing_table>, [[<tag:items:forge:ingots/wrought_iron>, <tag:items:forge:ingots/wrought_iron>], [<tag:items:minecraft:logs>, <tag:items:minecraft:logs>], [<tag:items:minecraft:logs>, <tag:items:minecraft:logs>]]);
craftingTable.addShaped("n_furnace", <item:minecraft:furnace>, [[<item:kubejs:furnace_brick>, <item:kubejs:furnace_brick>, <item:kubejs:furnace_brick>], [<item:kubejs:furnace_brick>, <item:minecraft:air>, <item:kubejs:furnace_brick>], [<tag:items:nethersdelight:stone_crafting_materials_no_blackstone>, <tag:items:nethersdelight:stone_crafting_materials_no_blackstone>, <tag:items:nethersdelight:stone_crafting_materials_no_blackstone>]]);
craftingTable.addShaped("n_smoker", <item:minecraft:smoker>, [[<tag:items:forge:rods/treated_wood>, <item:gtceu:treated_wood_trapdoor>, <tag:items:forge:rods/treated_wood>], [<tag:items:forge:plates/steel>, <item:minecraft:furnace>, <tag:items:forge:plates/steel>], [<tag:items:forge:rods/treated_wood>, <item:minecraft:smooth_stone>, <tag:items:forge:rods/treated_wood>]]);
craftingTable.addShaped("n_blast_furnace", <item:minecraft:blast_furnace>, [[<tag:items:forge:ingots/steel>, <tag:items:forge:plates/wrought_iron>, <tag:items:forge:ingots/steel>], [<tag:items:forge:rods/wrought_iron>, <item:minecraft:furnace>, <tag:items:forge:rods/wrought_iron>], [<item:minecraft:smooth_stone>, <item:minecraft:smooth_stone>, <item:minecraft:smooth_stone>]]);
craftingTable.addShapeless("n_bedroll", <item:upgrade_aquatic:bedroll>, [<tag:items:forge:leather>, <tag:items:minecraft:wool>, <tag:items:minecraft:wool>]);

#. GregTech
craftingTable.addShaped("n_flint_pickaxe", <item:gtceu:flint_pickaxe>.withTag({DisallowContainerItem: 0, "GT.Tool": {ToolSpeed: 5.5, AttackDamage: 2.0, MaxDamage: 63, HarvestLevel: 1, Damage: 0, AttackSpeed: -2.8}, "GT.Behaviours": {}, HideFlags: 2}), [[<tag:items:forge:gems/flint>, <tag:items:forge:gems/flint>, <tag:items:forge:gems/flint>], [<item:minecraft:air>, <tag:items:forge:rods/wood>, <item:minecraft:air>], [<item:minecraft:air>, <tag:items:forge:rods/wood>, <item:minecraft:air>]]);
craftingTable.addShaped("n_flint_shovel", <item:gtceu:flint_shovel>.withTag({DisallowContainerItem: 0, "GT.Tool": {ToolSpeed: 5.5, AttackDamage: 2.0, MaxDamage: 63, HarvestLevel: 1, Damage: 0, AttackSpeed: -2.8}, "GT.Behaviours": {}, HideFlags: 2}), [[<item:minecraft:air>, <tag:items:forge:gems/flint>, <item:minecraft:air>], [<item:minecraft:air>, <tag:items:forge:rods/wood>, <item:minecraft:air>], [<item:minecraft:air>, <tag:items:forge:rods/wood>, <item:minecraft:air>]]);
craftingTable.addShaped("n_flint_axe", <item:gtceu:flint_axe>.withTag({DisallowContainerItem: 0, "GT.Tool": {ToolSpeed: 3.5, AttackDamage: 6.0, MaxDamage: 63, HarvestLevel: 1, Damage: 0, AttackSpeed: -3.2}, "GT.Behaviours": {DisableShields: 1, TreeFelling: 1}, HideFlags: 2}), [[<tag:items:forge:gems/flint>, <tag:items:forge:gems/flint>, <item:minecraft:air>], [<tag:items:forge:gems/flint>, <tag:items:forge:rods/wood>, <item:minecraft:air>], [<item:minecraft:air>, <tag:items:forge:rods/wood>, <item:minecraft:air>]]);
//craftingTable.addShaped("n_flint_sword", <item:gtceu:flint_sword>.withTag({DisallowContainerItem: 0, "GT.Tool": {AttackDamage: 4.0, Damage: 0, MaxDamage: 63, AttackSpeed: -2.4}, "GT.Behaviours": {}, HideFlags: 2}), [[<item:minecraft:air>, <tag:items:forge:gems/flint>, <item:minecraft:air>], [<item:minecraft:air>, <tag:items:forge:gems/flint>, <item:minecraft:air>], [<item:minecraft:air>, <tag:items:forge:rods/wood>, <item:minecraft:air>]]);
craftingTable.addShaped("n_flint_knife", <item:gtceu:flint_knife>.withTag({DisallowContainerItem: 0, "GT.Tool": {AttackDamage: 1.0, Damage: 0, MaxDamage: 63, AttackSpeed: 3.0}, "GT.Behaviours": {}, HideFlags: 2}), [[<item:minecraft:air>, <tag:items:forge:gems/flint>, <item:minecraft:air>], [<item:minecraft:air>, <tag:items:forge:rods/wood>, <item:minecraft:air>]]);
